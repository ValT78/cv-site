...
<section id="experience" class="relative py-20 overflow-hidden">
  ...
  <div class="absolute inset-0 bg-gradient-to-bl from-blue-800 to-gray-800 opacity-90"></div>
  ...
  <svg class="absolute inset-0 w-full h-full opacity-20 animate-spin-slow" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <pattern id="circuit" width="40" height="40" patternUnits="userSpaceOnUse">
        <path d="M0 20 h40 M20 0 v40" stroke="#fff" stroke-width="1"/>
      </pattern>
    </defs>
...
<!-- x-data="{ open: null }" -->
  <div class="relative max-w-4xl mx-auto px-4" >
    <h2 class="text-4xl font-bold text-white mb-16 text-center">Expériences Professionnelles</h2>

    <!-- Ligne de timeline -->
    <div class="absolute left-1/2 transform -translate-x-1 bg-gradient-to-b from-[#8c6c34] to-[#f8b730] w-1 h-full animate-pulse"></div>

    <div class="space-y-16 z-20 relative">
